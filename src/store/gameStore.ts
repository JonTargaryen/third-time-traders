...
function generateTravelEncounter(
  ...
  const factionEncounters: Record<string, TravelEncounter[]> = {
    'mughal-court': [
      {
        ...
        description: 'Mughal courtiers replenished your caravan and shared fuel from the imperial stores.',
        emoji: '👑',
        resourceDelta: { fuel: 12 },
        reputationDelta: { 'mughal-court': 3 },
      },
      {
        id: 'court-inspection',
        title: '🛡️ Imperial Patrol',
        description: 'A Mughal patrol inspected your goods. You passed with honours and earned the Emperor\'s favour.',
        emoji: '🛡️',
        resourceDelta: { gold: -5 },
        reputationDelta: { 'mughal-court': 5 },
      },
    ],
    'east-india-company': [
      {
        id: 'tea-bounty',
        title: '🍵 Tea Shipment',
        description: 'Company traders shared surplus tea and provisions. Your food stores overflow!',
        emoji: '🍵',
        resourceDelta: { food: 15 },
        reputationDelta: { 'east-india-company': 2 },
      },
      {
        id: 'company-contract',
        title: '📜 Company Contract',
        description: 'A Company factor offered you a supply contract. Water and provisions guaranteed.',
        emoji: '📜',
        resourceDelta: { water: 10 },
        reputationDelta: { 'east-india-company': 3 },
      },
    ],
    'rajput-clans': [
      {
        ...
        description: 'Rajput scouts led you to a hidden oasis in the Thar. Water and rest for all!',
        emoji: '🏝️',
        resourceDelta: { water: 12, food: 5 },
        reputationDelta: { 'rajput-clans': 3 },
      },
      {
        id: 'desert-cache',
        title: '🪙 Desert Cache',
        description: 'You helped Rajput warriors unearth an ancient supply depot. They shared the find.',
        emoji: '🪙',
        resourceDelta: { fuel: 10, gold: 5 },
        reputationDelta: { 'rajput-clans': 2 },
      },
    ],
    'brahmin-council': [
      {
        id: 'temple-feast',
        title: '🙏 Temple Feast',
        description: 'The Brahmin Council invited you to a langar at the ghats. Amazing food!',
        emoji: '🙏',
        resourceDelta: { food: 12, water: 5 },
        reputationDelta: { 'brahmin-council': 4 },
      },
      {
        id: 'herb-gift',
        title: '🌸 Ayurvedic Medicine',
        description: 'Council healers gifted you rare Ayurvedic herbs worth a fortune.',
        emoji: '🌸',
        resourceDelta: { gold: 12 },
        reputationDelta: { 'brahmin-council': 2 },
      },
    ],
    ...
    'nizams-court': [
      {
        id: 'nizam-tax',
        title: '� Nizam\'s Tax Collector',
        description: 'The Nizam\'s Court collected a "voluntary" tax. Best to comply.',
        emoji: '�',
        resourceDelta: { gold: -15 },
        reputationDelta: { 'nizams-court': 4 },
      },
      {
        id: 'nizam-favor',
        title: '🏰 Royal Favour',
        description: 'A courtier noticed your loyalty. A gift from the Nizam arrived.',
        emoji: '🏰',
        resourceDelta: { gold: 20, information: 3 },
        reputationDelta: { 'nizams-court': 2 },
      },
    ],
  };
